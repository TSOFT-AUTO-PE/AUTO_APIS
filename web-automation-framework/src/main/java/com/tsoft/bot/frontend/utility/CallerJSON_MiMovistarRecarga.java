...
public class CallerJSON_MiMovistarRecarga {
    ...
    private static final String EXCEL_WEB = "excel/Recargas.xlsx";
    ...
    private static String blockIP(String ip) throws IOException {
        ...
        String url = result;
        String urlF = url.substring(8, url.length() -2);
        ExcelReader.writeCellValue(EXCEL_WEB, RECARGAS_WEB, 2, 2, urlF);

        System.out.println("Resultado: " + urlF);
        return urlF;
